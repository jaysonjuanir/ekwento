	...
	<body>
		...
		<div id="show-userRole" class="content scaffold-show" role="main">
			...
			<ol class="property-list userRole">
				...
				<g:if test="${userRoleInstance?.authority}">
				<li class="fieldcontain">
					<span id="authority-label" class="property-label"><g:message code="userRole.authority.label" default="Authority" /></span>
					
						<span class="property-value" aria-labelledby="authority-label"><g:fieldValue bean="${userRoleInstance}" field="authority"/></span>
