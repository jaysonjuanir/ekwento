...
<html>
    <head>
        <title>Reject Manga | e-Kwento</title>
        <meta charset="utf-8"/>
						...
						<!-- Modal content-->
							<div class="modal-content">
								<div class="modal-header">
									<h4 class="modal-title">${mangaInstance.title} - ${mangaInstance.createdBy}</h4>
								</div>
								<div class="modal-body">
									<div class="form-group">
										...
										<g:actionSubmit class="btn btn-success" value="Reject" action="updateRejectAdminManga" />
