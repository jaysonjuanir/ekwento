...
<html>
    <head>
        <title>Reject Book | e-Kwento</title>
        <meta charset="utf-8"/>
						...
						<!-- Modal content-->
							<div class="modal-content">
								<div class="modal-header">
									<h4 class="modal-title">${bookInstance.title} - ${bookInstance.createdBy}</h4>
								</div>
								<div class="modal-body">
									<div class="form-group">
										...
										<g:actionSubmit class="btn btn-success" value="Reject" action="updateRejectAdminBook" />
