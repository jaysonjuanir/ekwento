...
<html>
    <head>
		...
		<title>Popular Uploads List | e-Kwento - MMM</title>
    </head>
    <body id="page-top">
        <!-- HEADER -->
        <section class="header hris-section" id="contact" style="padding-top: 1px;">
			<div class="container">
				<div class="row tableDesign">
					<div class="col-md-12">
						<h2 class="caption">Popular Uploads List</h2>
						
						<div class="clearfix"></div>
						<div class="pagination" style="float:right;">
							<ul class="paginateButtons">
								<g:paginate controller="home" action="popularUploads" total="${popularGlobalCount}"/>
							</ul>
						</div>
						...
						<table class="table-bordered table-hover">
							...
							<tbody>
								<g:each var="searchInstance" in="${popularGlobalList}">
									<tr>
										...
										<g:elseif test="${searchInstance.type=='article'}">
											...
											<td data-label="Logo">
												<g:if test="${searchInstance.logo}">
													<g:link title="${searchInstance.description}" controller="manga" action="show" id="${searchInstance.id}" class="nameLink"><img src="${createLink (controller:'article' , action:'renderImage' , id:searchInstance.id)}" alt="articleLogo" height="75" width="75"/></g:link>
												</g:if>
												<g:else>
